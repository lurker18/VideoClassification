...
import random
import pdb
from core.mvit.video_perturb import VideoPerturbation
...
class ActionRecognitionUniformFrames(Dataset):
    def __init__(self, config, split, few_shot_sample=None):
        ...
        self.temporal_perturbations = ['box_jumble', 'freeze', 'jumble', 'reverse_sampling', 'sampling', 'temporal', 'mixed']
...
class RandomPerturbation(object):
    def __init__(self, num_frames, perturbation, severity, p=.5, train=False):
        temporal_perturbations = ['box_jumble', 'freeze', 'jumble', 'reverse_sampling', 'sampling', 'temporal', 'mixed']
